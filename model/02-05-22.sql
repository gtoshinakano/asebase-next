...
CREATE TABLE `accounts` (
  ...
  `providerAccount_Id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  PRIMARY KEY (`id`),
  KEY `provider_account_id` (`providerAccount_Id`),
...
CREATE TABLE `sessions` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `session_token` (`sessionToken`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
