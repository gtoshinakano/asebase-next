...
export const updateFullName = async (data) => {
  const ret = await axios.put(`${API_ADDRESS}/api/member/update/full_name`, data)
  return ret.data
}

export const updateBirthDate = async (data) => {
  const ret = await axios.put(`${API_ADDRESS}/api/member/update/birth_date`, data)
  return ret.data
}
...
export const updateBirthCity = async (data) => {
  const ret = await axios.put(`${API_ADDRESS}/api/member/update/birth_city`, data)
  return ret.data
}

export const updateBirthState = async (data) => {
  const ret = await axios.put(`${API_ADDRESS}/api/member/update/birth_state`, data)
  return ret.data
}

export const updateIsNikkei = async (data) => {
  const ret = await axios.put(`${API_ADDRESS}/api/member/update/is_nikkei`, data)
  return ret.data
}